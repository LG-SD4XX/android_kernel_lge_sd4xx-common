...
/* Definition of external DSV setting mode */
/* Modes generally-used */
#define POWER_ON 			"power_on_mode_reg"
#define POWER_OFF			"power_off_mode_reg"
#define ENM_ENTER 			"enm_enter_mode_reg"
#define ENM_EXIT			"enm_exit_mode_reg"
#define FAST_DISCHARGING	"fast_discharging_mode_reg"
#define FLOATING 			"floating_mode_reg"
/* Modes devided-steps-needed */
#define POWER_ON_1 			"power_on_1_mode_reg"
#define POWER_ON_2 			"power_on_2_mode_reg"
#define POWER_OFF_1			"power_off_1_mode_reg"
#define POWER_OFF_2			"power_off_2_mode_reg"
...
#endif
extern int ext_dsv_mode_change(const char *name);
