...
#define PLL_XTAL_MODE		//Master
#define USE_PLL_MODE_DTS
#define DAC_DEBUG

#define REG_26_VAL	0x20	//for adjustment
#define REG_2A_VAL	0x07	//fot adjustment
...
#ifdef DAC_DEBUG
#define AK4376_25_DAC32_DEBUG1			0x25
#define AK4376_26_DAC32_DEBUG2			0x26
#define AK4376_27_HDP_DEBUG1			0x27
#define AK4376_28_HDP_DEBUG2			0x28
#define AK4376_29_DADIG_MODE			0x29
#define AK4376_2A_LDO3_DEBUG1			0x2A
#define AK4376_2B_LDO3_DEBUG2			0x2B
#define AK4376_2C_PLL_DEBUG				0x2C
#define AK4376_MAX_REGISTERS	(AK4376_2C_PLL_DEBUG + 1)
#else
